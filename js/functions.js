...
var helloMessage = sayHello('Jose');
...
var total = Number(prompt('How much was your bill?'));
var percent = Number(prompt('How much would you like to tip?')) / 100;

var tiptotal = calculateTip(percent, total);

alert('Your tip should be $' + tiptotal.toFixed(2));
