...
function analyzeColor(input) {
    if (input === 'red'){
        ...
        return "Green apples are sour.";
    } else if (input === 'blue') {
        return "Blue is the color of the sky.";
    } else if (input === 'indigo') {
        return "Indigo is the color of eggplants.";
    } else if (input === 'violet') {
        return "Lilacs are violet.";
    } else {
...
// function calculateTotal(luckyNumber, totalInDollars) {
//     var amountOwed;
//     if (luckyNumber === 0) {
//         amountOwed = totalInDollars;
//     } else if (luckyNumber === 1) {
//         amountOwed = totalInDollars - (totalInDollars * .1);
//     } else if (luckyNumber === 2) {
//         amountOwed = totalInDollars - (totalInDollars * .25);
//     } else if (luckyNumber === 3) {
//         amountOwed = totalInDollars - (totalInDollars * .35);
//     } else if (luckyNumber === 4) {
//         amountOwed = totalInDollars - (totalInDollars * .50);
//     } else {
//     }
//     return amountOwed;
// }
...
//****continue here ****
// function caulateTotal(luckyNum, totalAmountDollars) {
//     switch (luckyNum) {
//         case 0:
...
// var billMessage = 'you lucky number is ' + luckyNumber
//     + '. Your original bill was ' + totalBillDollars
//     + ' and the final cost is ' + numToDollars(finalBillDollars) + '.';
//
// alert(billMessage);
//
